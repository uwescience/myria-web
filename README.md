...
# Initial setup
1. This project uses the [UW eScience Relational Algebra Compiler (RACO)](https://github.com/uwescience/raco) project. We have configured it as a submodule. After cloning the myria-web repository, you must run:
