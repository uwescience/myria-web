...
def mock_myria_get(url, request):
    ...
    twitter_dataset = {"relationKey":{"userName":"public", "programName":"adhoc", "relationName":"Twitter"}, "schema":{"columnTypes":["INT_TYPE", "INT_TYPE"], "columnNames":["followee", "follower"]}, "numTuples":1427579976, "queryId":2, "created":"2014-02-09T12:40:43.438-08:00", "howPartitioned":{"pf":None,"workers":None}, "uri":"http://fake.fake:12345/dataset/user-public/program-adhoc/relation-Twitter"}
    twitterk_dataset = {"relationKey":{"userName":"public", "programName":"adhoc", "relationName":"TwitterK"}, "schema":{"columnTypes":["INT_TYPE", "INT_TYPE"], "columnNames":["followee", "follower"]}, "numTuples":2715, "queryId":3, "created":"2014-02-09T12:40:43.438-08:00", "howPartitioned":{"pf":None,"workers":None}, "uri":"http://fake.fake:12345/dataset/user-public/program-adhoc/relation-TwitterK"}
