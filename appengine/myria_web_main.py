...
class istcdemo(MyriaPage):
    ...
    def get(self):
        ...
        tsne_clusters = connection.download_dataset({"userName":"public", "programName":"adhoc","relationName":"tsne_clusters"})
        ...
        template_vars['tsne_clusters'] = json.dumps(tsne_clusters).encode('utf8')
